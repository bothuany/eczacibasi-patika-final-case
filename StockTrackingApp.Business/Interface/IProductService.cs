...
namespace StockTrackingApp.Business.Interface
{
    public interface IProductService
    {
        ...
        ServiceResult<List<GetAllProductsWithStocksDto>> Search(string name, int? categoryId, int? brandId, double? minPrice, int? sizeId, int? colorId, bool withStocks = true, int page = 0, int pageSize = -1);
